...
[Demo Link <br>![CodePen](https://img.shields.io/badge/Codepen-000000?style=for-the-badge&logo=codepen&logoColor=white)](https://codepen.io/AlexGolovanov/pen/gOKvzQG)

![gif](readme/gif.webp)

## Info

Создано на основе задания по курсу [Captain Anonymous]().

Для обучения и отработки работы с **HTML** и **CSS**.  
Создание собственного лайтбокса для изображений.  
С возможностью уменьшать и увеличивать.
